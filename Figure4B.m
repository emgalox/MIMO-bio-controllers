...
%parameters
b1=2; b2=1;d1=1;d2=1;a1=0.1;a2=0.4; k1=1; k2=3; k3=2; n=10 ;th1=4; th2=5;
dist=2;
...
dydt(3,1)=th1 + k1*y(1) - n*y(3)*y(4); %Z1
dydt(4,1)=th2 + k2*y(2) - n*y(3)*y(4); %Z2
end
end
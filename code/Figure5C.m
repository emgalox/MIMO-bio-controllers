...
%parameters
b1=2; b2=1;d1=1;d2=1;a1=0.1;a2=0.4; k1=0.5; k2=2; k3=0.5; k4=2; n1=0.5; n2=10; th1=8; 
dist=2;
...
dydt(1,1)=b1 - d1*y(1) + a1*y(2) + k3*y(5) + dist*heaviside(t-50) ;%Y1                                  
...
dydt(6,1)=n1*y(3)*y(5) - n2*y(4)*y(6);%C
end
end
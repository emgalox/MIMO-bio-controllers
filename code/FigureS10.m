...
legend(' Y1','Y2','Y3','(Y1+Y2)/Y3','Location','southeast','FontName', 'Arial','FontSize',18)
saveas(gcf,'FigureS10.pdf')
...
k1=0.5; k2=0.5; k3=5; n=10; k4=6; dist=2;
...
dydt(7,1)= k1*y(1)+ k2*y(2)- n*y(7)*y(8); %Z1
dydt(8,1)= k3*y(3)- n*y(7)*y(8); %Z2
end
end
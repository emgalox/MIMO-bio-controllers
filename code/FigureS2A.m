...
%parameters
b1=2; b2=1;d1=1;d2=1;a1=0.1;a2=0.4; k1=0.5; k2=1; k3=2; n=10; k4=2;p=0.5;
...
dydt(3,1)=(k1-p*k1*heaviside(t-330))*y(1) - (n+p*n*heaviside(t-90))*y(3)*y(4); %Z1
dydt(4,1)=(k2-p*k2*heaviside(t-240))*y(2) - (n+p*n*heaviside(t-90))*y(3)*y(4); %Z2
end
end
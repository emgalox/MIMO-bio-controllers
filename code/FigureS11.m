...
p4=plot(t,y(:,1).*y(:,2)./y(:,3),'--','color','[0 0 0]');
hold off
p1.LineWidth = 2;
p2.LineWidth = 2;
p3.LineWidth = 2;
...
legend(' Y1','Y2','Y3','Y1Y2/Y3','Location','southeast','FontName', 'Arial','FontSize',18)
saveas(gcf,'FigureS11.pdf')
...
k1=1.5; k2=1; n=10; k3=20;dist=2; 

[t,y]=ode23s(@sol,tspace,[0.0001;0.0001;0.0001;0.0001;0.0001;0.0001;0.0001;0.0001]);

%ODE model
function dydt=sol(t,y)
dydt(1,1)= a1*y(4)- d1*y(1) - k1*y(1)*y(2) ;%Y1                        
dydt(2,1)=a2*y(5) -d2*y(2)- k1*y(1)*y(2); %Y2
dydt(3,1)= a3*y(6) - d3*y(3) ; %Y3
dydt(4,1)= b1 - d4*y(4) - a4*y(4)*y(3) ; %Y4
dydt(5,1)=b2 - d5*y(5) - a5*y(5)*y(3) + dist*heaviside(t-50); %Y5
dydt(6,1)=b3 - d6*y(6)- a6*y(6)*y(1)- a7*y(6)*y(2) - k3*y(6)*y(8);%Y6
dydt(7,1)= k1*y(1)*y(2)- n*y(7)*y(8); %Z1
dydt(8,1)= k2*y(3)- n*y(7)*y(8); %Z2
end
end